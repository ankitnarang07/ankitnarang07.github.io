...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        if (this.loginForm.controls.email.value == 'ankit.narang@netsolutions.com' && this.loginForm.controls.password.value == 'ankit685') {
            this.router.navigate(['list-user']);
        }
        else {
...
module.exports = __webpack_require__(/*! C:\Users\ankit.narang\angular-apps\my-app\src\main.ts */"./src/main.ts");
